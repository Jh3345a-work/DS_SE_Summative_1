# DS_SE_Summative_1
A repo for my Summative 1 assignment for the Software Engineering module (2000 words +- 10%).

# Assessment Task:

## Propose
Propose a new prdouct for your employer or a small-scale side proejct for yourself or your team. It may be either:
- (a) A simple web app (written in HTML, CSS, and JavaScript).
